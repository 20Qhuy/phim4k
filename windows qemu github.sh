...
qemu-system-x86_64 -vnc :0 -net nic -net user,hostfwd=tcp::3389-:3389 -drive format=raw,file=win.img -smp cores=16 -m 32G -machine usb=on -device e1000e,netdev=n0 -accel tcg -device virtio-serial-pci -device usb-tablet
