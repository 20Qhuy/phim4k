...
qemu-system-x86_64 -cpu max -drive format=raw,file=win.img  -smp cores=64  -m 32G -machine usb=on -device usb-tablet -device virtio-gpu-pci -accel tcg -vnc :0,password free -net user,hostfwd=tcp::2222-:22
