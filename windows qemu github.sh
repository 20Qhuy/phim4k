...
qemu-system-x86_64 -cpu max -drive format=raw,file=win.img  -smp cores=64  -m 32G -machine usb=on -device virtio-gpu-pci -accel tcg -dislay vnc:0 -net user,hostfwd=tcp::2222-:22
